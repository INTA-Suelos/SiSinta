class AnaliticoSerializer < ActiveModel::Serializer
  attributes  :registro, :humedad, :s, :t, :ph_pasta, :ph_h2o, :ph_kcl,
              ...
              :arena_gruesa, :arena_muy_gruesa, :arena_total, :gravas, :ca_co3,
              :agua_15_atm, :agua_util, :conductividad, :h, :saturacion_t,
              :saturacion_s_h, :densidad_aparente, :profundidad_muestra,
              :agua_3_atm, :carbono_organico_cn, :base_al, :p_ppm
end
